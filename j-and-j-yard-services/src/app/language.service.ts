  ...
  private translations: any = {
    en: {
      ...
      contact: {
        ...
        sentBody: 'Thanks, {name}. We received your message and will reply to {email} within one business day.',
        sentHint: 'Need something sooner? Give us a call at +1 801-574-7943.',
        sendAnother: 'Send another message',
        errorTitle: "Your message didn't go through.",
        errorBody: 'Something went wrong on our end. Your message is still in the form below, so please try again in a moment.',
        errorOffline: "We couldn't reach the server. Check your internet connection and try again; your message is still in the form below.",
    ...
    es: {
      ...
      contact: {
        ...
        sentBody: 'Gracias, {name}. Recibimos su mensaje y le responderemos a {email} dentro de un día hábil.',
        sentHint: '¿Necesita algo más pronto? Llámenos al +1 801-574-7943.',
        sendAnother: 'Enviar otro mensaje',
        errorTitle: 'Su mensaje no se pudo enviar.',
        errorBody: 'Algo salió mal de nuestro lado. Su mensaje sigue en el formulario, por favor inténtelo de nuevo en un momento.',
        errorOffline: 'No pudimos conectar con el servidor. Revise su conexión a internet e inténtelo de nuevo; su mensaje sigue en el formulario.',
        errorFallback: 'También puede contactarnos directamente en',
        or: 'o',
